...
func ListProviders(cfg *config.Config) []ProviderInfo {
	...
	add("openai", cfg.Providers.OpenAI, []string{
		"gpt-5.5", "gpt-5.4", "gpt-5.3-codex", "gpt-5.3-codex-spark", "gpt-5.2-codex", "gpt-5.2",
	})
...
func knownModelsForProvider(provider string) []string {
	...
	case "openai":
		return []string{"gpt-5.5", "gpt-5.4", "gpt-5.3-codex", "gpt-5.3-codex-spark", "gpt-5.2-codex", "gpt-5.2"}
	case "gemini":
